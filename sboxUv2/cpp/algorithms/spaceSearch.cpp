...
// !SUBSECTION! The MSBSpectrum class 
...
// !SUBSECTION! Sopthisticated MSBSpectrum-based vector extraction

std::vector<BinWord> cpp_super_extract_vector(
    const std::vector<BinWord> &z,
...
// !SUBSECTION! The recursive search
    ...
    else
    {
        ...
        for (unsigned int slice_index=0; slice_index<spec.size(); slice_index++)
        {
            ...
            {                
                ...
                {
                    const BinWord a = z[i];
                    std::vector<BinWord> z_a = std::move(cpp_super_extract_vector(
                                                                   z,
                                                                   spec,
                                                                   a,
                                                                   slice_index));
...
// !SUBSECTION! Vector space extracting functions 
