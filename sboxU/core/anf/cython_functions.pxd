...
from sboxU.core.spectrum cimport cpp_Spectrum
...
cdef extern from "../../cpp/core/anf.hpp":
    ...
    std_vector[BinWord] cpp_linear_compact_representation(const cpp_S_box& f)
    std_vector[BinWord] cpp_linear_sbox_from_compact_representation(std_vector[BinWord] compact_representation, int64_t n, int64_t m)
