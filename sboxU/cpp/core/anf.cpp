...
/// @param f a ccp_S_box
/// @return a vector of BinWord containing the representation
std::vector<BinWord> cpp_linear_compact_representation( const cpp_S_box &f){
...
/// @brief Computes a lut from the compact representation of a linear function 
/// @param  compact_representation std::vector<BinWord>  containing the representation
/// @param n input length
/// @param m output length
/// @return a lut std::vector<BinWord> 
std::vector<BinWord> cpp_linear_sbox_from_compact_representation(std::vector<BinWord> compact_representation, int64_t n, int64_t m){
